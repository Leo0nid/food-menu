...
function refreshCustomTabs(nuxt = (0, _kit.useNuxt)()) {
  return nuxt.callHook("devtools:customTabs:refresh");
}
function startSubprocess(execaOptions, tabOptions, nuxt = (0, _kit.useNuxt)()) {
  const id = tabOptions.id;
  let restarting = false;
  function start() {
    const process2 = (0, _execa.execa)(
...
function extendServerRpc(namespace, functions, nuxt = (0, _kit.useNuxt)()) {
...
function onDevToolsInitialized(fn, nuxt = (0, _kit.useNuxt)()) {
  nuxt.hook("devtools:initialized", fn);
}
function _getContext(nuxt = (0, _kit.useNuxt)()) {
